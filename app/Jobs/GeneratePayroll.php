...
class GeneratePayroll implements ShouldQueue
{
    ...
    public function __construct($from_date,$to_date,$send_mail, $qry)
    {
    ...
    public function handle()
    {
        ...
        if($this->locatons)
            $user_query->whereHas('profile',function($query){
                $query->whereIn('location_id',$this->locatons);
            });
