						    ...
						    <div class="user-profile-content-wm">
						    	...
						    	<?php echo Form::model($localization,['method' => 'PATCH','route' => ['localization.plugin',$locale] ,'class' => 'localization-plugin-form','id'=>'localization-plugin-form','data-no-form-clear' => 1]); ?>
								  ...
								  <div class="form-group">
									...
									<?php echo Form::select('datatable', config('locale-datatable'),isset($locale) ? config('lang.'.$locale.'.datatable') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')]); ?>

								  </div>
								  <div class="form-group">
								    <?php echo Form::label('calendar',trans('messages.calendar').' '.trans('messages.localization'),[]); ?>

									<?php echo Form::select('calendar', config('locale-calendar'),isset($locale) ? config('lang.'.$locale.'.calendar') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')]); ?>

								  </div>
								  <div class="form-group">
								    <?php echo Form::label('datepicker',trans('messages.datepicker').' '.trans('messages.localization'),[]); ?>

									<?php echo Form::select('datepicker', config('locale-datepicker'),isset($locale) ? config('lang.'.$locale.'.datepicker') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')]); ?>

								  </div>
								  <div class="form-group">
								    <?php echo Form::label('datetimepicker',trans('messages.datetimepicker').' '.trans('messages.localization'),[]); ?>

									<?php echo Form::select('datetimepicker', config('locale-datetimepicker'),isset($locale) ? config('lang.'.$locale.'.datetimepicker') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')]); ?>
