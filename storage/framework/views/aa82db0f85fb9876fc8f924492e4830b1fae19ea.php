			  ...
			  <div class="form-group">
				...
				<?php echo Form::input('text','name',isset($locale) ? config('localization.'.$locale.'.localization') : '',['class'=>'form-control','placeholder'=>trans('messages.localization').' '.trans('messages.name')]); ?>
