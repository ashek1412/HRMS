			<div class="col-sm-6">
			  ...
			  <div class="form-group">
				...
				<?php echo Form::input('text','nexmo_from_number',config('config.nexmo_from_number') ? config('config.hidden_value') : '',['class'=>'form-control','placeholder'=>'From Number']); ?>

			  </div>
			  <div class="form-group">
			    <?php echo Form::label('your_number','Your Mobile Number',[]); ?>

				<?php echo Form::input('text','your_number',config('config.your_number') ? config('config.hidden_value') : '',['class'=>'form-control','placeholder'=>'Your Number']); ?>
