	<?php $__env->startSection('breadcrumb'); ?>
		<ul class="breadcrumb">
		    ...
		    <li class="active"><?php echo trans('messages.upload').' '.trans('messages.log'); ?></li>
		</ul>
		...
		<div class="row">
			<div class="col-sm-6 collapse" id="box-detail-filter">
				<div class="box-info">
					...
					<?php echo Form::open(['url' => 'filter','id' => 'upload-log-filter-form','data-no-form-clear' => 1]); ?>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box-info full">
                    <h2>
						<strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.upload').' '.trans('messages.log'); ?>
					...
					<?php echo $__env->make('global.datatable',['table' => $table_data['upload-log-table']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
