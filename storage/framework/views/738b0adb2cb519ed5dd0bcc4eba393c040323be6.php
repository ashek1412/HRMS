	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			...
			<div class="col-md-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.user'); ?></h2>
					...
					<?php echo Form::open(['route' => 'register','role' => 'form', 'class'=>'user-form','id' => 'user-form']); ?>
			...
			<div class="col-sm-12 collapse" id="box-detail-filter">
				<div class="box-info">
					...
					<?php echo Form::open(['url' => 'filter','id' => 'user-filter-form','data-no-form-clear' => 1]); ?>
			...
			<div class="col-md-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.user'); ?>
					...
					<?php echo $__env->make('global.datatable',['table' => $table_data['user-table']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
