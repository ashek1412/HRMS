...
<div class="full-content-center animated fadeInDownBig">
    ...
    <?php if(!getMode()): ?>
        <br />
        <br />
        <?php echo $__env->make('global.notification',['message' => 'Most awaited Version 3.2 Released with new features on 1st April 2017. <a href="#" data-href="/whats-new" data-toggle="modal" data-target="#myModal">Click here to check Whats New?</a>' ,'type' => 'success'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
