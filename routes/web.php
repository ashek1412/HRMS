...
Route::group(['middleware' => ['auth','web','account','lock_screen']], function () {
	...
	Route::post('/shift-calendar-events','HomeController@shiftCalendarEvents');
	...
	Route::group(['middleware' => ['permission:manage-configuration']], function() {
		...
		Route::model('salary_profile','\App\SalaryProfile');
		Route::post('/salary-profile/lists','SalaryProfileController@lists');
		Route::resource('/salary-profile', 'SalaryProfileController');
		...
		Route::model('qualification_score_type','\App\QualificationScoreType');
		Route::post('/qualification-score-type/lists','QualificationScoreTypeController@lists');
		Route::resource('/qualification-score-type', 'QualificationScoreTypeController');
	...
	Route::get('/date-wise-user-attendance','ClockController@dateWiseUserAttendance');
	Route::post('/date-wise-user-attendance',array('as' => 'clock.date-wise-user-attendance','uses' => 'ClockController@dateWiseUserAttendanceLists'));
