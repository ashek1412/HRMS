		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					{!! Form::label('qualification_score_type_id',trans('messages.score'),[])!!}
					{!! Form::select('qualification_score_type_id', $qualification_score_types,isset($user_qualification) ? $user_qualification->qualification_score_type_id : '',['class'=>'form-control input-xlarge show-tick','title' => trans('messages.select_one')])!!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					{!! Form::label('qualification_score',trans('messages.score_val'))!!}
					{!! Form::input('text','qualification_score',isset($user_qualification) ? $user_qualification->qualification_score : '',['class'=>'form-control','placeholder'=>trans('messages.score_val')])!!}
				</div>
			</div>
		</div>
		<div class="row">
