				...
				<div class="box-info">
					...
					<div class="table-responsive">
						<table class="table table-stripped table-hover table-bordered">
							...
							<tr>
								<td colspan = "2" valign="top" style="padding:0px;">
									<table class="table" style="border:0px">
										<thead>
											<tr>
												<th>{!! trans('messages.earning').' '.trans('messages.salary') !!} </th>
								...
								<td colspan = "2" valign="top" style="padding:0px;">
									<table class="table">
										<thead>
										<tr>
											<th>{!! trans('messages.deduction').' '.trans('messages.salary') !!} </th>
											<td align="right">{!! trans('messages.amount') !!} </td>
										</tr>
										</thead>
										<tbody>
							...
							@endif
							<tr>
								<th>{!! trans('messages.net').' '.trans('messages.salary') !!} </th>
						...
						<p class="pull-right" style="margin-top:20px;margin-right:10px;">{!! trans('messages.authorized_signatory') !!}</p>
					</div>
				</div>
