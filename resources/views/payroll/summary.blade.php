					...
					<div class="table-responsive">
						<table class="table table-hover table-striped show-table">
							<tbody>
								...
								<tr>
									<th><span class="label label-info">{!! trans('messages.holiday') !!}/Off</span></th>
									<td>{!! $att_summary['H'] !!}</td>
								</tr>
								<tr>
								...
								<tr>
									<th><span class="label label-warning">{!! trans('Leave With Pay') !!}</span></th>
									<td>{!! $att_summary['L'] !!}</td>
								</tr>
								<tr>
									<th><span class="label label-warning">{!! trans('Leave Without Pay') !!}</span></th>
									<td>{!! $att_summary['LWP'] !!}</td>
								</tr>
								<tr>
