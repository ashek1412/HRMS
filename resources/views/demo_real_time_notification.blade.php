		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-info">
					...
					<p>To check Real Time Notification, open <a href="/">http://ez.wmlab.in</a> in any other browser say Firefox or  Safari, Login as other user and then click on the below link:</p>
