    ...
    public function lists(Request $request){
        ...
        foreach($users as $user){
            ...
            $row = array(
                ...
                (Entrust::can('delete-user') ? '<a href="/user-shift/'.$user->UserShift[0]->id.'/edit"  class="btn btn-xs btn-default" data-toggle="modal" data-target="#myModal" ><i class="fa fa-edit" data-toggle="tooltip" title="'.trans('messages.edit').'"></i></a>' : '').
                '</div>',
