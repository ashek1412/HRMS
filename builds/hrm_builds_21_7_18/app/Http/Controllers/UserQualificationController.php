...
Class UserQualificationController extends Controller{
    ...
    public function edit(UserQualification $user_qualification){
       ...
       // dd($qualification_score_types);
        ...
        return view('user_qualification.edit',compact('user_qualification','custom_user_qualification_field_values','education_levels','uploads','qualification_languages','qualification_skills','qualification_score_types'));
    }
