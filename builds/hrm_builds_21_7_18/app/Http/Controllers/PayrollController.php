...
Class PayrollController extends Controller{
	...
	public function index(){
		...
		array_push($data,trans('messages.overtime').' '.trans('messages.salary'));
	...
	public function lists(Request $request){
        ...
        foreach($payrolls as $payroll){
		    ...
		    $row = array(
		        ...
		        $payroll->User->Profile->employee_code,
		        $payroll->User->fullname,
		        date('d M Y',strtotime($payroll->date_of_payroll)),
	...
	public function createMultiple(){
		...
		return view('payroll.multiple', compact('locations'));
	}
	...
	public function postCreateMultiple(Request $request){
		...
		$this->dispatch(new GeneratePayroll($from_date,$to_date,$send_mail,$locations));
