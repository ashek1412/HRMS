		...
		<div class="form-group">
			...
			<div class="input-daterange input-group" id="datepicker">
				<input type="text" class="input-sm form-control" name="probation_from_date" readonly value="{{isset($user_employment) ? $user_employment->probation_from_date : ''}}" />
				<span class="input-group-addon">{{trans('messages.to')}}</span>
				<input type="text" class="input-sm form-control" name="probation_to_date" readonly value="{{isset($user_employment) ? $user_employment->probation_to_date : ''}}"  />
			</div>
		</div>
		<div class="form-group">
