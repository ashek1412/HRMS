                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control text-input @if(config('config.enable_password_strength_meter')) password-strength @endif" name="password" value="usbe@2018">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('role_id', $roles,'3',['class'=>'form-control show-tick','title' => trans('messages.select_one')])!!}
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {!! Form::label('employee_code',trans('messages.empid'),[])!!}
                                    <input type="text" class="form-control text-input " name="employee_code" placeholder="{{trans('messages.empid')}}">
                                </div>
                            </div>
                        </div>
                    </div>
