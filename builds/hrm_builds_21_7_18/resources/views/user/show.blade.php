						...
						<div class="tab-content col-md-10 col-xs-10" style="padding:0px 25px 10px 25px;">
						  <div class="tab-pane animated fadeInRight" id="basic-tab">
							<div class="user-profile-content-wm">
								<div id="usr_id" style="display: none">{{$user->id}}</div>
									...
									{!! Form::model($user,['method' => 'POST','route' => ['user.profile-update',$user->id] ,'class' => 'user-profile-form','id' => 'user-profile-form','data-no-form-clear' => 1,'data-refresh' => 'load-user-detail']) !!}
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													{!! Form::label('employee_type',trans('messages.employee_type'),[])!!}
													{!! Form::select('employee_type', translateList('employee_type'),$user->Profile->employee_type,['class'=>'form-control show-tick','title'=>trans('messages.select_one')])!!}
												</div>
											  <div class="form-group">
												...
												<div class="row">
													<div class="col-xs-6">
													  <div class="form-group">
															...
															<div class="checkbox">
									                            @foreach(config('lists.gender') as $gender)
									    		            	<input type="radio" class="form-control icheck" name="gender" value="{{$gender}}" {{($user->Profile->gender == $gender) ? 'checked' : ''}}> {{trans('messages.'.$gender)}}
									                            @endforeach
															</div>
														</div>
													</div>
											...
											<div class="col-md-6">
											  ...
											  <div class="form-group">
												...
												<div class="form-group">
													{!! Form::label('address',trans('messages.praddress'),[])!!}
												...
												<div class="form-group">
													{!! Form::label('address',trans('messages.pmaddress'),[])!!}
													{!! Form::input('text','paddress_line_1',$user->Profile->paddress_line_1,['class'=>'form-control','placeholder'=>trans('messages.address_line_1')])!!}
													<br />
													{!! Form::input('text','paddress_line_2',$user->Profile->paddress_line_2,['class'=>'form-control','placeholder'=>trans('messages.address_line_2')])!!}
													<br />
													<div class="row">
														<div class="col-xs-5">
															{!! Form::input('text','pcity',$user->Profile->pcity,['class'=>'form-control','placeholder'=>trans('messages.city')])!!}
														</div>
														<div class="col-xs-4">
															{!! Form::input('text','pstate',$user->Profile->pstate,['class'=>'form-control','placeholder'=>trans('messages.state')])!!}
														</div>
														<div class="col-xs-3">
															{!! Form::input('text','pzipcode',$user->Profile->pzipcode,['class'=>'form-control','placeholder'=>trans('messages.zipcode')])!!}
														</div>
													</div>
													<br />
													{!! Form::select('pcountry_id', [null => trans('messages.select_one')] + config('country'),$user->Profile->pcountry_id,['class'=>'form-control show-tick','title'=>trans('messages.country')])!!}
												</div>
											</div>
										</div>
										<div class="row">
