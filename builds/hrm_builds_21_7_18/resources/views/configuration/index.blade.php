				...
				<div class="box-info full">
					<div class="tabs-left">	
						<ul class="nav nav-tabs col-md-2 tab-list" style="padding-right:0;">
							...
							<li><a href="#salaryprofile-tab" data-toggle="tab">{{trans('messages.salary_profile')}}</a>
							</li>
						  ...
						  <div class="tab-pane animated fadeInRight" id="qualification-tab">
						    <div class="user-profile-content-wm">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="box-info">
											<h2><strong>{!! trans('messages.add_new') !!}</strong> {!! trans('messages.qualification').' '.trans('messages.score') !!}</h2>
											{!! Form::open(['route' => 'qualification-score-type.store','role' => 'form', 'class'=>'qualification-score-type-form','id' => 'qualification-score-type-form','data-table-refresh' => 'qualification-score-type-table']) !!}
									...
									<div class="col-sm-8">
										<div class="box-info full">
											<h2><strong>{!! trans('messages.list_all') !!}</strong> {!! trans('messages.qualification').' '.trans('messages.score') !!}</h2>
											<div class="table-responsive">
