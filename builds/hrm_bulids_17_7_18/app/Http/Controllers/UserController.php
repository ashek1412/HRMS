        ...
        foreach($users as $user){
           ...
           // foreach($user->roles as $role)
            ...
            $row = array(
                ...
                ((Entrust::can('edit-user')||Entrust::can('update-shift')) ? '<a href="/user/'.$user->username.'" class="btn btn-xs btn-default"> <i class="fa fa-arrow-circle-right" data-toggle="tooltip" title="'.trans('messages.view').'"></i></a> ': '').
