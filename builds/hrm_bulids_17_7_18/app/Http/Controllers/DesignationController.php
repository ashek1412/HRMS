...
Class DesignationController extends Controller{
	...
	public function index(Designation $designation){
		...
		$job_grades= \App\JobGrade::all()->pluck('name','id')->all();
        $data = array(
		...
		return view('designation.index',compact('table_data','assets','menu','top_designations','departments','job_grades'));
	}
	...
	public function edit(Designation $designation){
		...
		return view('designation.edit',compact('designation','top_designations','custom_field_values','departments','job_grades'));
	}
	...
	public function update(DesignationRequest $request, Designation $designation){
		...
		//if($data['job_grade_id'] != null)
			// return response()->json(['message' => trans($data['job_grade_id']), 'status' => 'error']);
