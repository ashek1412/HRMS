        ...
        @if(!isset($job_detail))
            	...
            	<div class="col-sm-6">
    		        <div class="form-group">
    		            ...
    		            <div class="checkbox">
    		            	...
    		            	<input type="radio" class="form-control icheck" name="gender" value="{{$gender}}" {{(isset($job_application) && $job_application->gender == $gender) ? 'checked' : (!isset($job_application) ? 'checked' : '')}}> {{trans('messages.'.$gender)}}
                            @endforeach
    		            </div>
    		        </div>
    		    </div>
    		...
    		<div class="form-group">
    			...
    			<div class="row">
    				...
    				<div class="col-xs-3">
    				{!! Form::input('text','zipcode',isset($job_application) ? $job_application->zipcode : '',['class'=>'form-control','placeholder'=>trans('messages.zipcode')])!!}
    				</div>
    			</div>
    			<br />
