		...
		<div class="form-group hourly_salary_field">
		    {!! Form::label('hourly',trans('messages.hourly').' '.trans('messages.salary'),[])!!}
			{!! Form::input('text','hourly',isset($hourly) ? $hourly : '',['class'=>'form-control','placeholder'=>trans('messages.hourly').' '.trans('messages.salary')])!!}
		</div>
		<div class="monthly_salary_field">
			<div class="row">
				<div class="col-sm-6">
		  			...
		  			<div class="form-group">
					    {!! Form::label('overtime',trans('messages.overtime').' '.trans('messages.salary'),[])!!}
						{!! Form::input('text','overtime',isset($overtime) ? $overtime : '',['class'=>'form-control','placeholder'=>trans('messages.overtime').' '.trans('messages.salary')])!!}
					</div>
				</div>
		  		<div class="col-sm-6">
		  			<h6>({!! trans('messages.deduction').' '.trans('messages.salary') !!})</h6>
		  			<div class="form-group">
					    {!! Form::label('late',trans('messages.late').' '.trans('messages.salary'),[])!!}
						{!! Form::input('text','late',isset($late) ? $late : '',['class'=>'form-control','placeholder'=>trans('messages.late').' '.trans('messages.salary')])!!}
					</div>
		  			<div class="form-group">
					    {!! Form::label('early_leaving',trans('messages.early_leaving').' '.trans('messages.salary'),[])!!}
						{!! Form::input('text','early_leaving',isset($early_leaving) ? $early_leaving : '',['class'=>'form-control','placeholder'=>trans('messages.early_leaving').' '.trans('messages.salary')])!!}
					</div>
				</div>
			</div>
			<hr />
