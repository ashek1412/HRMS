              ...
              <div class="form-group">
                {!! Form::label('job_grade_id',trans('messages.job_grade'),[])!!}
                {!! Form::select('job_grade_id', $job_grades,isset($designation) ? $designation->job_grade_id : '',['class'=>'form-control input-xlarge show-tick','title' => trans('messages.select_one')])!!}
              </div>
