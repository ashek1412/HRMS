		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="box-info full">
					...
					<p><strong>{{trans('messages.shift').' '.trans('messages.detail')}}: {!! showDateTime($user_shift->in_time) !!} to {!! showDateTime($user_shift->out_time) !!}</strong></p>
						...
						<div class="row">
							...
							<div class="col-md-4">{!! Form::input('text','remarks','',['class'=>'form-control text-input','placeholder'=>trans('messages.remarks')])!!}</div>
							</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<br><button type="submit" class="btn btn-success">{!! trans('messages.add_new') !!}</button>
								</div>
							</div>
						</div>
						{!! Form::close() !!}
